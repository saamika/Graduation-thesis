...
public abstract class Report {
	private static int addressFromHigh = 210;
	private static int addressFromAdj = 230;
	...
	public static int getAddressFromAdj() {
		return addressFromAdj;
	}

	public static void setAddressFromAdj(int addressFromAdj) {
		Report.addressFromAdj = addressFromAdj;
	}

	public static int getAddressFromHigh() {
		return addressFromHigh;
	}

	public static void setAddressFromHigh(int addressFromHigh) {
		Report.addressFromHigh = addressFromHigh;
	}
