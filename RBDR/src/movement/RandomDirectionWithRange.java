 ...
 * @author teemuk
 */
public class RandomDirectionWithRange
extends MovementModel {

    private Coord lastWaypoint;
	public static final String MOVING_RANGE = "MovingRange";
    ...
    //========================================================================//
    public RandomDirectionWithRange( Settings settings ) {
        super( settings );
        
        int ranges[];
        
        ranges = settings.getCsvInts(MOVING_RANGE,2);
        this.rangeX = ranges[0];
        this.rangeY = ranges[1];
    }

    public RandomDirectionWithRange( RandomDirectionWithRange other ) {
        super( other );
        this.rangeX = other.getRangeX();
        this.rangeY = other.getRangeY();
    }
    ...
    public MovementModel replicate() {
        return new RandomDirectionWithRange( this );
    }
    //========================================================================//
     ...
     * @author Me
     */
    public void setLastWaypoint(Coord lp) {
    	this.lastWaypoint = lp;
    }
