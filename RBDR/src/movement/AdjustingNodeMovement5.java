 ...
 * @author teemuk
 */
public class AdjustingNodeMovement5
extends MovementModel {
	...
	//========================================================================//
	public AdjustingNodeMovement5( Settings settings ) {
		super( settings );
		int aNs[];
	...
	public AdjustingNodeMovement5( AdjustingNodeMovement5 other ) {
		super( other );
	...
	public MovementModel replicate() {
		return new AdjustingNodeMovement5( this );
	}
	//========================================================================//
