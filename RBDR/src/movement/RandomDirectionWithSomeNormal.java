 ...
 * @author teemuk
 */
public class RandomDirectionWithSomeNormal
extends MovementModel {
    ...
    //========================================================================//
    public RandomDirectionWithSomeNormal( Settings settings ) {
        super( settings );
    }

    public RandomDirectionWithSomeNormal( RandomDirectionWithSomeNormal other ) {
        super( other );
    }
    ...
    public MovementModel replicate() {
        return new RandomDirectionWithSomeNormal( this );
    }
    //========================================================================//
