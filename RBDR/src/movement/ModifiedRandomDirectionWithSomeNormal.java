 ...
 * @author teemuk
 */
public class ModifiedRandomDirectionWithSomeNormal
extends RandomDirectionWithSomeNormal {

    public ModifiedRandomDirectionWithSomeNormal( Settings settings ) {
        super( settings );
        }

    public ModifiedRandomDirectionWithSomeNormal( ModifiedRandomDirectionWithSomeNormal other ) {
        super( other );
    }
    ...
    public MovementModel replicate() {
        return new ModifiedRandomDirectionWithSomeNormal( this );
    }
