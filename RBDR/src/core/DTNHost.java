...
public class DTNHost implements Comparable<DTNHost> {
	...
	public DTNHost(List<MessageListener> msgLs,
		...
		if(address>=addressFromHigh && address<addressFromAdj) {
			reputation = 10;
		}else if(address>=addressFromAdj) {
			reputation = -1;
		}else{
			reputation = 1;
		}
		//		reputation = 1;
		System.out.println("node"+address+"'s Reputation: "+reputation);
	}
	...
	public double getRepu() {
		// TODO 自動生成されたメソッド・スタブ
		return reputation;
	}

	public void setRepu(double r) {
		reputation = r;
	}
